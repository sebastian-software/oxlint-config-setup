...
the main TypeScript loaders and the Vitest/Jest loaders. They do not depend on a
React option or a selected test runner, and the package supplies the required
runtime.
