...
| Storybook                      | Deferred       | `*.stories.{ts,tsx}` is reserved; no JavaScript plugin ships            | Deferred until Issue #32 proves story-only extension and framework/parser isolation       |
